...
@celery_app.task(name="src.tasks.analysis_tasks.process_daily_analysis")
...
@celery_app.task(name="src.tasks.analysis_tasks.process_seasonal_analysis")
...
@celery_app.task(name="src.tasks.analysis_tasks.process_correlation_analysis")
...
celery_app.conf.task_routes = {'src.tasks.analysis_tasks.*': {'queue': 'weather_tasks'}}